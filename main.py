...
from view import percetagem_valor, pie_valores,inserir_categoria, inserir_receita, inserir_gastos,ver_categoria, tabela, deletar_gastos, deletar_receitas, bar_valores
...
def percentagem():
    l_nome = Label(frameMeio, text="Receita Restante", height=1, anchor=NW, font=('Verdana 12'), bg=co1, fg=co4)
    ...
    bar.place(x=10, y=35)
    bar['value'] = percetagem_valor()[0]

    valor = percetagem_valor()[0]
...
def resumo():
    ...
    l_linha = Label(frameMeio, text="", width=60, height=1, anchor=NW, font=('Arial 1'), bg='#545454')
    l_linha.place(x=309, y=52)
    l_sumario = Label(frameMeio, text="Total Renda Mensal      ".upper(), anchor=NW, font=('Verdana 12'), bg=co1, fg='#83a9e6')
    l_sumario.place(x=309, y=40)
...
# Botao inserir
img_add_receitas = Image.open('mais.png')
img_add_receitas = img_add_receitas.resize((17, 17))
img_add_receitas = ImageTk.PhotoImage(img_add_receitas)
botao_inserir_receita =Button(frame_configuracao,command= inserir_receitas_b, image = img_add_receitas, text="Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE )
